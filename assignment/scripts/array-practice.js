...
let favoriteFoods = ['chicken', 'potatoes', 'cheesecake', 'salad', 'steak'];
...
console.log('Dessert added to the end:', favoriteFoods);
...
console.log('Entree added to the beginning:', favoriteFoods);
...
let colorfulGems = ['Tourmaline', 'Topaz', 'Tanzanite', 'Iolite', 'Emerald', 'Diamond', 'yellow', 'green'];
colorfulGems.join(' ');
